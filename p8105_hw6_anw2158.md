...
Based on domain knowledge, factors like gestational age, mother’s health
(e.g., pre-pregnancy BMI, weight gain during pregnancy), and baby’s
health (e.g., presence of malformations) could be significant
predictors.
...
Model 2: Length and Gestational Age as Predictors This model uses only
...
Model 3: Head Circumference, Length, Sex, and Interactions This model
includes all possible interactions between head circumference, length,
and sex.
...
Cross-Validation and Prediction Error Comparison We’ll use
cross-validation to compare models based on prediction error.
...
![](p8105_hw6_anw2158_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
